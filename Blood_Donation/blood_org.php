...
<form id="bloodRequestForm" action="submit_organization_blood_request.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-step active">
            ...
            <input type="text" name="organization_name" value="<?php echo htmlspecialchars($organization_name); ?>" readonly><br>
                    ...
                    <!-- Select New Organization Image -->
        <label>Select New Image:</label>
        <input type="file" name="blood_request_image" accept="image/*"><br>
...
<select name="org_blood_district" required>
